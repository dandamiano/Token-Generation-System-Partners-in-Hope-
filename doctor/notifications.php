...
$query_unread = "
    ...
    WHERE doctor_id = '$doctor_id' AND status = 'unread'
...
$query_read = "
    SELECT * FROM admin_notifications 
    WHERE doctor_id = '$doctor_id' AND status = 'read'
    ORDER BY created_at DESC
";
...
if (isset($_GET['mark_as_read'])) {
    ...
    $update_query = "UPDATE admin_notifications SET status = 'read' WHERE notification_id = '$notification_id' AND doctor_id = '$doctor_id'";

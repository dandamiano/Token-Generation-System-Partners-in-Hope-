...
$query_unread_count = "SELECT COUNT(*) as unread_count FROM admin_notifications WHERE status ='unread' AND admin_id = '$admin_id'";
...
$query_unread_notifications = "SELECT * FROM admin_notifications WHERE status = 'unread' AND admin_id = '$admin_id' LIMIT 5";

...
if (isset($_GET['mark_as_read'])) {
    ...
    $update_query = "UPDATE admin_notifications SET status = 'read' WHERE notification_id = '$notification_id' AND receptionist_id = '$receptionist_id'";
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h4 class="mt-3">All Notifications</h4>

...
$query_unread_count = "SELECT COUNT(*) as unread_count FROM admin_notifications WHERE status ='unread' ";
...
$query_unread_notifications = "SELECT * FROM admin_notifications WHERE status = 'unread'  LIMIT 5";

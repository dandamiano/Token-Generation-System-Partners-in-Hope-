...
$completedAppointmentsQuery = "SELECT COUNT(*) AS completed_appointments FROM appointments WHERE status = 'completed'";
...
// Query to calculate average waiting time
$averageWaitingTimeQuery = "SELECT AVG(TIMESTAMPDIFF(MINUTE, created_at, appointment_date)) AS average_waiting_time FROM appointments";
...
$totalReceptionistsQuery = "SELECT COUNT(*) AS total_receptionists FROM receptionist";
$totalReceptionistsResult = mysqli_query($conn, $totalReceptionistsQuery);
$totalReceptionists = mysqli_fetch_assoc($totalReceptionistsResult)['total_receptionists'];

// Query to get number of patients treated this month
...
// Query to get number of patients treated this week
...
// Query to get tokens generated this week
$tokensThisWeekQuery = "
...
// Query to get tokens generated this month
...
// Query to get tokens generated this year
$tokensThisYearQuery = "
        ...
        <table class="table table-striped table-bordered">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?php echo htmlspecialchars($totalPatients); ?></td>
                </tr>
                <tr>
                    <td>Total Doctors</td>
                    <td><?php echo htmlspecialchars($totalDoctors); ?></td>
                </tr>
                <tr>
                    <td>Total Receptionists</td>
                    <td><?php echo htmlspecialchars($totalReceptionists); ?></td>
                </tr>
                <tr>

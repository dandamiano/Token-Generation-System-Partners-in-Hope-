...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $stmt = $db->prepare("SELECT * FROM receptionist WHERE email = :email");
    ...
    if ($user && password_verify($password, $user['password'])) {
        $_SESSION['receptionist_id'] = $user['receptionist_id']; // Store admin ID in session
    ...
    ********************-->
    ...
    .logo img {
        ...
        height: auto;      /* Maintain aspect ratio */
                               ...
                               <a class="text-center mt-3" href="index.html"> <h4>Receptionist Portal</h4></a>

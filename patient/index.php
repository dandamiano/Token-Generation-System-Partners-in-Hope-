...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // Prepare and execute the query to check user credentials from the 'patient' table
    ...
    if ($patient && password_verify($password, $patient['password'])) {
        $_SESSION['patient_id'] = $patient['patient_id']; // Store patient ID in session
                    ...
                    <div class="form-input-content">
                        <div class="card login-form mb-0">
                            <div class="card-body pt-5">
                               ...
                               <a class="text-center mt-3" href="index.html"> <h4>Patient Portal</h4></a>
                               <div class="container mt-5">
                                   ...
                                   <form class="mt-4 mb-5" method="POST">
                                       ...
                                       <p>Don't Have an Account? <a href="register.php" class="text-primary text-right mt-3 mb-3">Register</a></p>
                                   </form>
                               </div>
                            </div>
                        </div>
